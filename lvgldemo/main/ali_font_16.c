 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font /root/hmi_esp32/hmi/aliph.ttf -r 0x20-0x7F --symbols 测试 --size 16 --format lvgl --bpp 4 --no-compress -o ali_font_16.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3977, .adv_w = 252, .box_w = 16, .box_h = 15, .ofs_x = 0, .ofs_y = -1}
};
